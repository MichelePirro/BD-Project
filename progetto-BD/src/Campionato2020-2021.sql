...
CREATE TABLE squadra (
  ...
  PRIMARY KEY (CodS),
  KEY CodC (CodC),
  CONSTRAINT squadra_ibfk_1 FOREIGN KEY (CodC) REFERENCES campionato (CodC) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CodS varchar(30) NOT NULL,
PRIMARY KEY (CodAll),
CONSTRAINT allenamento_ibfk_1 FOREIGN KEY (CodS) REFERENCES squadra (CodS) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE giocatore (
  ...
  PRIMARY KEY (CodT),
  KEY CodS (CodS),
  CONSTRAINT giocatore_ibfk_1 FOREIGN KEY (CodS) REFERENCES squadra (CodS) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE partecipat (
  ...
  KEY CodT (CodT),
  CONSTRAINT partecipat_ibfk_1 FOREIGN KEY (CodS) REFERENCES squadra (CodS) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT partecipat_ibfk_2 FOREIGN KEY (CodT) REFERENCES torneo (CodT) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE partita (
  ...
  CodST varchar(30),
  CodFCasa varchar(30),
  CodFTrasferta varchar(30),
  PRIMARY KEY (CodP,CodSCasa),
  KEY CodSCasa (CodSCasa),
  KEY CodSTrasferta (CodSTrasferta),
  CONSTRAINT partita_ibfk_1 FOREIGN KEY (CodSCasa) REFERENCES squadra (CodS) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT partita_ibfk_2 FOREIGN KEY (CodSTrasferta) REFERENCES squadra (CodS) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT arbitro_ibfk_3 FOREIGN KEY (CodAr) REFERENCES arbitro (CodAr) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT stadio_ibfk_4 FOREIGN KEY (CodST) REFERENCES stadio (CodST) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT formazione_ibfk_5 FOREIGN KEY (CodFCasa) REFERENCES formazione (CodF) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT formazione_ibfk_6 FOREIGN KEY (CodFTrasferta) REFERENCES formazione (CodF) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE allenatore (
  ...
  PRIMARY KEY (CodT,CodS),
   KEY CodS ( CodS ),
   CONSTRAINT allenatore_ibfk_1 FOREIGN KEY ( CodS ) REFERENCES squadra ( CodS ) ON DELETE CASCADE ON UPDATE CASCADE
);
...
Durata int NOT NULL,
PRIMARY KEY (CodDir),
CONSTRAINT dirigenza_ibfk_1 FOREIGN KEY (CodT)  REFERENCES allenatore (CodT) ON DELETE CASCADE ON UPDATE CASCADE
);
...
PRIMARY KEY (CodInf),
CONSTRAINT infortunio_ibfk_1 FOREIGN KEY (CodT)  REFERENCES giocatore (CodT) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE VIEW s AS SELECT 
 ...
 CREATE VIEW n AS (select s.NomeS AS NomeS,s.CodS AS codS,
count(t.CodT) AS numtor from ((torneo t join squadra s) join partecipat p) 
where ((t.CodT = p.CodT) and (p.CodS = s.CodS)) group by s.NomeS,s.CodS);


DROP VIEW IF EXISTS s;
CREATE VIEW s AS (select s.CodS AS codS,s.NomeS AS NomeS,
sum(g.Stipendio) AS sommastip from ((squadra s join giocatore g) join campionato c)
 where ((g.CodS = s.CodS) and (s.CodC = c.CodC) and (c.NomeC = 'Serie A')) 
 group by s.CodS,s.NomeS);
...
INSERT INTO squadra VALUES ('eng1','Manchester City','camp3',34,14),
('eng2','Manchester United','camp3',36,24),
('eng3','Tottenham','camp3',35,28),
('eng4','Chealsea','camp3',32,45),
('eng5','Liverpool','camp3',52,65),
('eng6','West Ham','camp3',35,44),
('eng7','Southampton FC','camp3',12,55),
('fra1','Paris Saint Germain','camp2',34,5),
('fra2','OGC Nice','camp2',39,65),
('fra3','Saint Etienne','camp2',56,99),
('fra4','AS Monaco','camp2',67,34),
('fra5','Olympique Lione','camp2',27,26),
('fra6','Olympique Marseille','camp2',24,34),
('ger1','Bayern Monaco','camp5',14,36),
('ger2','Borussia Dortmund','camp5',24,17),
('ger3','Borussia Monchengladbach','camp5',23,34),
('ger4','Bayern Leverkusen','camp5',12,25),
('ger5','Red Bull Lipsia','camp5',12,23),
('ita1','Milan','camp1',34,45),
('ita2','Juventus','camp1',12,23),
('ita3','Napoli','camp1',24,34),
('ita4','Roma','camp1',32,5),
('ita5','Inter','camp1',33,25),
('ita6','Fiorentina','camp1',12,42),
('ita7','Sampdoria','camp1',33,44),
('ita8','Benevento','camp1',32,30),
('ita9','Atalanta','camp1',31,40),
('ola1','PSV Heindoven','camp6',22,55),
('ola2','Feeyenord','camp6',34,5),
('ola3','Ajax','camp6',52,35),
('spa1','Real Madrid','camp4',37,42),
('spa2','Barcellona','camp4',22,46),
('spa3','Atletico Madrid','camp4',34,42),
('spa4','Athletic Bilbao','camp4',22,35),
('spa5','Valencia','camp4',22,44),
('spa6','Siviglia FC','camp4',31,42);
